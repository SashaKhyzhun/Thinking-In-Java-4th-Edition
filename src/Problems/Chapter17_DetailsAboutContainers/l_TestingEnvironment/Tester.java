...
public class Tester<C> {
    ...
    // Переопределите этот метод, чтобы изменить
    // предварительную инициализацию до выполнения теста:
    ...
    // Вспомагательные обобщенные методы:
